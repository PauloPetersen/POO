...
public class TesteEmpregado {
	...
	public static void main(String[] args) {
		//Empregado empregado = new Empregado("Jorge", "jorge@gmail.com", 5000.);
		Tecnico tecnico = new Tecnico("Paulo", "paulo@gmail.com", 6000.);
		Programador programador = new Programador ("Bela", "bela@gmail.com", 6200., "Phyton");
